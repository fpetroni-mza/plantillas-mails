...
export default function Layout09() {
    return (
        <>
            <div>
                <h1>Ampliación Profesional - Vehículos de gran porte o maquinaria</h1>
                <h2>Documentación a presentar:</h2>
                <ul>
                    <li>Original y copia del DNI</li>
                    <li>Certificados <strong>impresos</strong> de asistencias a los módulos del Curso Nacional de Educación Vial (Categorías, Género y Estrellas Amarillas) o comprobante de asistencia al curso presencial.</li>
                    ...
                    <li>En caso de rendir con tráiler, debe estar <strong>homologado</strong> e incluído en la póliza del seguro del vehículo.</li>
